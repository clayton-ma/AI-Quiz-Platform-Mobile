        ...
        >
            <View style={styles.overlay}>
                <View style={[styles.alertBox, { backgroundColor: theme.colors.card }]}>
                    ...
                    <Text style={[styles.message, { color: theme.dark ? "#ccc" : "#7F8C8D" }]}>
                        Please find a stable place to take the quiz. It is better for your eyes and ensures the best experience.
                    </Text>
                    <Button
                        ...
                        icon={<Icon name="close" size={15} color="#E74C3C" style={{ marginRight: 5, marginTop: 10 }} />}
                    />
                </View>
            </View>
        </Modal>
