  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={styles.header}>
        <Text style={[styles.title, { color: theme.colors.text }]}>Edit Group Settings</Text>
        <TouchableOpacity
      ...
      <View style={[styles.card, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}>
        <Text style={[styles.label, { color: theme.colors.text }]}>Add Member</Text>
        <View style={styles.row}>
          <TextInput
            ...
            autoCapitalize="none"
          />
          <TouchableOpacity style={[styles.addButton, { backgroundColor: theme.colors.primary }]} onPress={handleAddMember}>
        ...
        {admins.map((admin) => (
          <View key={admin.email} style={styles.memberRow}>
            ...
            <TouchableOpacity onPress={() => handleRemoveUser(admin.email, true)}>
        ...
        {members.map((member) => (
          <View key={member.email} style={styles.memberRow}>
            ...
            <View style={styles.row}>
              <TouchableOpacity onPress={() => handlePromoteToAdmin(member.email)}>
                <Text style={[styles.promoteText, { color: theme.colors.primary }]}>Promote</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => handleRemoveUser(member.email, false)}>
                <Text style={[styles.removeText, { marginLeft: 10 }]}>Remove</Text>
              </TouchableOpacity>
            </View>
          </View>
        ))}
